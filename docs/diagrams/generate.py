...
def ai_pipeline():
    ...
    b += node(440, 120, 170, 70, "classify", "sentiment + emotion · Qwen3 Instruct", ACCENT, "#ffffff")
    b += node(630, 120, 170, 70, "synthesize", "themes + actions + taxonomy · Gemini Flash-Lite", ACCENT, "#ffffff")
    ...
    b += node(590, 510, 200, 70, "Student Qwen3", "classify before / after", ACCENT, "#ffffff")
    b += node(850, 510, 190, 70, "Agreement", "93% → 94%", GOOD, "#ecfdf5")
